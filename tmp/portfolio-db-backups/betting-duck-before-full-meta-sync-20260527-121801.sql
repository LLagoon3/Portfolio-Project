...
INSERT INTO `PROJECT_COMPANY_INFO` VALUES (104,'서비스','클래스업 (학원 SaaS)',0,2),(105,'팀 구성','2명 (FE 1, BE 1)',1,2),(106,'담당','백엔드 전반 (API · DB · RAG · OpenAI 연동)',2,2),(107,'기간','2025.10 ~ 2025.12',3,2),(108,'서비스','클래스업 학생앱',0,3),(109,'팀 구성','3명 (FE 2, BE 1)',1,3),(110,'담당','백엔드 전반 (타이머 API · DB 설계 · Mongo↔DynamoDB 마이그레이션)',2,3),(111,'기간','2025.08 ~ 2025.10',3,3),(112,'서비스','실시간 베팅 서비스',0,4),(113,'팀 구성','4명 (FE 2, BE 2)',1,4),(114,'담당','아키텍처 기획 · 백엔드 개발 · Redis 메시지 큐',2,4),(115,'기간','2024.10 ~ 2025.02',3,4),(116,'서비스','학술 동아리 CaTs 챗봇 서비스',0,5),(117,'팀 구성','2명 (FE 1, BE 1)',1,5),(118,'담당','백엔드 총괄 · 동아리 서버 구축 (기여도 80%)',2,5),(119,'기간','2024.01 ~ 2024.05 (운영·유지보수 ~2025)',3,5),(120,'프로젝트 성격','개인 프로젝트 (기여도 100%)',0,6),(121,'담당','프레임워크 코어 · MVC 애플리케이션 · 배포 전반',1,6),(122,'기간','2025.03 ~ 2025.06',2,6),(123,'배포','Linux 홈 서버 + Docker Compose + Nginx',3,6),(124,'Repository','https://github.com/LLagoon3/Custom_Web_Framework',4,6),(125,'프로젝트 성격','개인 프로젝트 (기여도 100%)',0,1),(126,'팀 구성','1명',1,1),(127,'담당','설계 · 구현 · 사내 배포',2,1),(128,'기간','2026.01 ~ 2026.03',3,1),(129,'배포','사내 서버, Docker Compose',4,1);
...
INSERT INTO `PROJECT_TECHNOLOGY` VALUES (25,'Tools & Technologies',0,2),(26,'Tools & Technologies',0,3),(27,'Tools & Technologies',0,4),(28,'Tools & Technologies',0,5),(29,'Tools & Technologies',0,6),(30,'Tools & Technologies',0,1);
...
INSERT INTO `PROJECT_TECHNOLOGY_ITEM` VALUES (196,'Express.js',0,25),(197,'TypeScript',1,25),(198,'MySQL',2,25),(199,'Sequelize',3,25),(200,'MongoDB',4,25),(201,'MongoDB Vector Search',5,25),(202,'OpenAI API',6,25),(203,'Swagger',7,25),(204,'Express.js',0,26),(205,'TypeScript',1,26),(206,'MySQL',2,26),(207,'Sequelize',3,26),(208,'MongoDB',4,26),(209,'DynamoDB',5,26),(210,'Joi',6,26),(211,'Swagger',7,26),(212,'TypeScript',0,27),(213,'Node.js',1,27),(214,'Redis',2,27),(215,'WebSocket',3,27),(216,'HINCRBY',4,27),(217,'Pub/Sub',5,27),(218,'MessageQueue',6,27),(219,'Python',0,28),(220,'Django',1,28),(221,'MySQL',2,28),(222,'Kakao Chatbot',3,28),(223,'cron',4,28),(224,'mysqldump',5,28),(225,'requests',6,28),(226,'TypeScript',0,29),(227,'Node.js net module',1,29),(228,'HTML',2,29),(229,'CSS',3,29),(230,'JavaScript',4,29),(231,'MySQL',5,29),(232,'Redis',6,29),(233,'Lua Script',7,29),(234,'Docker Compose',8,29),(235,'Nginx',9,29),(236,'Linux',10,29),(237,'Node.js',0,30),(238,'TypeScript',1,30),(239,'NestJS',2,30),(240,'syslog-ng',3,30),(241,'Vector',4,30),(242,'Loki',5,30),(243,'Grafana',6,30),(244,'Docker Compose',7,30),(245,'Teams Webhook',8,30),(246,'MCP',9,30),(247,'JSON-RPC',10,30);
...
INSERT INTO `PROJECT_QUOTE` VALUES (18,'RAG 는 검색 결과를 LLM 에 넘기는 작업이 아니라, 어떤 데이터를 신뢰할지 정하는 일이다.','프로젝트 회고',2,'2026-05-26 23:06:27.904264'),(19,'UI 가 멈춰도 시간은 흐른다. 신뢰할 수 있는 시계는 서버에 두기로 했다.','프로젝트 회고',3,'2026-05-26 23:07:40.410168'),(22,'프레임워크를 사용한다는 것과 만든다는 것 사이엔, 디버깅 가능한 추상화의 깊이가 있다.','프로젝트 회고',6,'2026-05-26 23:17:28.836530'),(23,'로그를 모으는 것보다 어려운 건, 다른 형태의 데이터를 같은 기준으로 보게 만드는 일이었다.','프로젝트 회고',1,'2026-05-26 23:28:31.181313'),(24,'복구에서 끝내지 않고, 다시 복구할 수 있는 구조를 남겼습니다.','프로젝트 회고',5,'2026-05-27 11:39:05.154140'),(25,'실시간 서비스에서는 기능보다 먼저, 상태 변화가 안전하게 흘러가는 구조가 필요했습니다.','프로젝트 회고',4,'2026-05-27 12:16:42.644473');
...
-- Dump completed on 2026-05-27 12:18:01
