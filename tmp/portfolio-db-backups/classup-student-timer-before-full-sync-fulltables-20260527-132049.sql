...
INSERT INTO `PROJECT_COMPANY_INFO` VALUES (104,'서비스','클래스업 (학원 SaaS)',0,2),(105,'팀 구성','2명 (FE 1, BE 1)',1,2),(106,'담당','백엔드 전반 (API · DB · RAG · OpenAI 연동)',2,2),(107,'기간','2025.10 ~ 2025.12',3,2),(108,'서비스','클래스업 학생앱',0,3),(109,'팀 구성','3명 (FE 2, BE 1)',1,3),(110,'담당','백엔드 전반 (타이머 API · DB 설계 · Mongo↔DynamoDB 마이그레이션)',2,3),(111,'기간','2025.08 ~ 2025.10',3,3),(116,'서비스','학술 동아리 CaTs 챗봇 서비스',0,5),(117,'팀 구성','2명 (FE 1, BE 1)',1,5),(118,'담당','백엔드 총괄 · 동아리 서버 구축 (기여도 80%)',2,5),(119,'기간','2024.01 ~ 2024.05 (운영·유지보수 ~2025)',3,5),(125,'프로젝트 성격','개인 프로젝트 (기여도 100%)',0,1),(126,'팀 구성','1명',1,1),(127,'담당','설계 · 구현 · 사내 배포',2,1),(128,'기간','2026.01 ~ 2026.03',3,1),(129,'배포','사내 서버, Docker Compose',4,1),(130,'서비스','실시간 베팅·채팅 서비스',0,4),(131,'팀 구성','4명 (FE 2, BE 2)',1,4),(132,'담당','아키텍처 기획 · 백엔드 개발 · Redis 큐/캐시 · 실시간 처리 (기여도 30%)',2,4),(133,'기간','2024.10 ~ 2025.02',3,4),(139,'프로젝트 성격','개인 프로젝트 (기여도 100%)',0,6),(140,'담당','프레임워크 코어 · HTTP 파서 · Router/Middleware · MVC 앱 · 배포',1,6),(141,'기간','2025.03 ~ 2025.06',2,6),(142,'배포','Linux 홈 서버 + Docker Compose + Nginx',3,6),(143,'Repository','https://github.com/LLagoon3/Custom_Web_Framework',4,6);
...
INSERT INTO `PROJECT_STAT` VALUES (24,'Query latency','-77%','복합 인덱스 + 키셋 페이지네이션',0,3,'2026-05-26 23:07:40.411844'),(28,'Log lookup','-86%','10–15분 → 1–2분',0,1,'2026-05-26 23:28:31.183291'),(29,'Maintenance','18mo','운영·유지보수',0,5,'2026-05-27 11:39:05.153604'),(30,'Crawling Cut','93%','2300ms → 170ms',1,5,'2026-05-27 11:39:05.153604'),(31,'Recovery Ready','Backup','로그 복구 후 정기 백업 도입',2,5,'2026-05-27 11:39:05.153604'),(36,'API Performance','10x','Redis 큐 적용 후 응답성 개선',0,4,'2026-05-27 12:21:49.749610'),(41,'OWNERSHIP','100%','설계 · 구현 · 배포 전 과정',0,6,'2026-05-27 13:11:28.705923');
...
INSERT INTO `PROJECT_QUOTE` VALUES (18,'RAG 는 검색 결과를 LLM 에 넘기는 작업이 아니라, 어떤 데이터를 신뢰할지 정하는 일이다.','프로젝트 회고',2,'2026-05-26 23:06:27.904264'),(19,'UI 가 멈춰도 시간은 흐른다. 신뢰할 수 있는 시계는 서버에 두기로 했다.','프로젝트 회고',3,'2026-05-26 23:07:40.410168'),(23,'로그를 모으는 것보다 어려운 건, 다른 형태의 데이터를 같은 기준으로 보게 만드는 일이었다.','프로젝트 회고',1,'2026-05-26 23:28:31.181313'),(24,'복구에서 끝내지 않고, 다시 복구할 수 있는 구조를 남겼습니다.','프로젝트 회고',5,'2026-05-27 11:39:05.154140'),(26,'실시간 서비스에서는 기능보다 먼저, 상태 변화가 안전하게 흘러가는 구조가 필요했습니다.','프로젝트 회고',4,'2026-05-27 12:21:49.745236'),(28,'프레임워크를 직접 만들며, 추상화가 어디서 시작되고 어디서 깨지는지 배웠습니다.','프로젝트 회고',6,'2026-05-27 12:31:39.288885');
...
INSERT INTO `PROJECT_TECHNOLOGY` VALUES (25,'Tools & Technologies',0,2),(26,'Tools & Technologies',0,3),(28,'Tools & Technologies',0,5),(30,'Tools & Technologies',0,1),(31,'Tools & Technologies',0,4),(34,'Tools & Technologies',0,6);
...
-- Dump completed on 2026-05-27 13:20:49
